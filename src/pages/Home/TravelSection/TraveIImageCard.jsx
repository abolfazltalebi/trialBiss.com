...
export default function TraveIImageCard({ image }) {
  return (
    <div className="relative group">
      <img src={image} alt="Travel" className="rounded-xl" />
      <div
        className={`absolute  bottom-3 top-3 rounded-full w-[98%] ml-1 h-[45px] 
      transition-all duration-500 px-5 bg-white/20 backdrop-blur-md flex items-center justify-between group-hover:top-[40%]
        `}
      >
