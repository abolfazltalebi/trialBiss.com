...
function checkVariant(variant) {
  ...
  if (variant === "heroSection") {
    return "bg-black text-white px-8 py-3 rounded-full m-auto text-sm flex items-center gap-2 transition-all hover:px-12 hover:scale-105 duration-500";
  }
  ...
  if (variant === "EventButton") {
    return "capitalize border text-black px-8 py-3 rounded-full m-auto text-sm flex items-center gap-2 transition-all hover:px-12 hover:scale-105 duration-500";
  }
